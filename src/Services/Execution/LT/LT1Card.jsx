...
export default function SmallCard(props)
{
    ...
    return <div className="col-lg-4">
        <div className="small-card" onMouseOver={()=>{
            var i=document.getElementsByClassName("lt1-img");
            i[id].style.color="orangered";
            var hr=document.getElementsByClassName("lt1-hr");
        ...
        <img src={props.icon} className="lt1-img" alt=""/>
        <h3>{props.title}</h3>
        <p>
