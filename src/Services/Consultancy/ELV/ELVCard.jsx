...
export default function SmallCard(props)
{
    ...
    return <div className="col-lg-4">
        <div className="small-card" onMouseOver={()=>{
            var i=document.getElementsByClassName("elv-img");
            i[id].style.color="orangered";
            var hr=document.getElementsByClassName("elv-hr");
        ...
        <img src={props.icon} className="elv-img" alt=""/>
        <h3>{props.title}</h3>
        <p>
